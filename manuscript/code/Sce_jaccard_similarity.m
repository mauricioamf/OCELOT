...
prod_rxn_list = {'r_4780','r_1589','r_2001','r_2056', 'r_1761'};
...
% Export
writetable(route_overlap_summary, 'Sce_route_overlap_summary.xlsx');
writetable(tf_route_coverage_table, 'Sce_tf_route_coverage.xlsx', 'WriteRowNames', true);
writetable(tf_route_weighted_table, 'Sce_tf_route_weighted_coverage.xlsx', 'WriteRowNames', true);
writetable(met_active_table, 'Sce_metabolite_active_jaccard.xlsx', 'WriteRowNames', true);
writetable(met_reg_table, 'Sce_metabolite_regulated_jaccard.xlsx', 'WriteRowNames', true);
writetable(tf_jaccard_table, 'Sce_tf_reaction_jaccard.xlsx', 'WriteRowNames', true);
writetable(reaction_summary, 'Sce_reaction_summary_by_metabolite.xlsx');
writetable(top_tf_per_met, 'Sce_topTFs_per_metabolite.xlsx');
if ~isempty(pred_tf_jaccard_table)
    writetable(pred_tf_jaccard_table, 'Sce_predictedTF_jaccard.xlsx', 'WriteRowNames', true);
end