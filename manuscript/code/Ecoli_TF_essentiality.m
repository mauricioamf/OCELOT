...
essentialityTable = readtable('../data/Ecoli_gene_essentiality.csv');
...
for c = 1:numel(unique_conditions)
    ...
    parfor i = 1:num_KOs
        ...
        gp_KO.sense      = [ repmat('=', m_KO, 1); repmat('<', n_KO, 1); repmat('<', n_KO, 1) ];
    ...
    for cutoffVal = cutoff_range
        ...
        y_true     = essentialityTable.Essentiality_0_11notkeeping(lia);
...
metrics_OCELOT_ecoli = metrics_all;
TF_growth_KO_OCELOT_ecoli = TF_growth_KO;

save('Ecoli_essentiality.mat', 'metrics_OCELOT_ecoli', 'TF_growth_KO_OCELOT_ecoli', '-v7.3');
